...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        do {
            ...
            System.out.println("10 - edit distance/levenshtein distance");
            System.out.println("11 - KMP");
            System.out.println("================================\n");
            ...
            switch (option) {
                ...
                case 10:{
                    System.out.println("\nlevenshtein");
                    String s = Crud.FiletoString(DEFAULT_FILE);
                    System.out.println("Digite o padrao: ");
                    String pat = scr.next();
                    long k = StringProcessing.levenshteinDistance(s, pat);
                    System.out.println("edit distance == " + k);
                    break;
                }
                case 11:{
                    ...
                    System.out.println("Digite o padrao: ");
                    String pat = scr.next();
                    int k = StringProcessing.kmp.solve(s, pat);
                    System.out.println(((k != -1)?"Padrao encontrado na posicao " + k:"Padrao nao encontrado"));
                    break;
                }
            }
        } while (option != 0);
